  ...
  const initWebSocket = () => {
    ...
    wsRef.current = Api.connectToChat(chatId, {
      ...
      onClose: (event) => {
        ...
        setError("Lost connection to the server. Attempting to reconnect...");
      },
    });
  };
...
//   const initChatConnection = () => {
//     const token = localStorage.getItem("token");
//     chatConnectionRef.current = new ChatConnection(chatId, token, {
//       onOpen: () => console.log("Chat connection opened"),
...
//       const sentMessage = await Api.sendMessage(chatId, message);
//       setMessages((prevMessages) => [sentMessage, ...prevMessages]);
//       chatConnectionRef.current.send(sentMessage);
//     } catch (error) {
//       console.error("Error sending message:", error);
//       setError("Failed to send message. Please try again.");
//     }
